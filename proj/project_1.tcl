...
#
# Generated by Vivado on Sun Nov 05 15:01:20 EST 2023
...
#
#    "/media/tony/TDG_512/projects/axil_stim0/hdl/axil_reg32.v"
#    "/media/tony/TDG_512/projects/AXIL_stim/proj/axil_traffic_data.coe"
#    "/media/tony/TDG_512/projects/AXIL_stim/proj/axil_traffic_addr.coe"
#    "/media/tony/TDG_512/projects/axil_stim0/sim/axil_stim.sv"
#    "/media/tony/TDG_512/projects/axil_stim0/sim/axil_stim2.sv"
#    "/media/tony/TDG_512/projects/axil_stim0/sim/sim_top_tb.sv"
#    "/media/tony/TDG_512/projects/axil_stim0/proj/sim_top_tb_behav.wcfg"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../hdl/axil_reg32.v"]"\
 "[file normalize "$origin_dir/../../AXIL_stim/proj/axil_traffic_data.coe"]"\
 "[file normalize "$origin_dir/../../AXIL_stim/proj/axil_traffic_addr.coe"]"\
 "[file normalize "$origin_dir/../sim/axil_stim.sv"]"\
 "[file normalize "$origin_dir/../sim/axil_stim2.sv"]"\
 "[file normalize "$origin_dir/../sim/sim_top_tb.sv"]"\
 "[file normalize "$origin_dir/sim_top_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/../hdl/axil_reg32.v"
...
set file "$origin_dir/../../AXIL_stim/proj/axil_traffic_data.coe"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "$origin_dir/../../AXIL_stim/proj/axil_traffic_addr.coe"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "sim_top_wrapper" -objects $obj
...
set file "$origin_dir/../sim/axil_stim.sv"
set file [file normalize $file]
...
set file "$origin_dir/../sim/axil_stim2.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../sim/sim_top_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sim_top_tb_behav.wcfg"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "sim_top_tb" -objects $obj
...
if { [get_files axil_reg32.v] == "" } {
  import_files -quiet -fileset sources_1 /media/tony/TDG_512/projects/axil_stim0/hdl/axil_reg32.v
}
if { [get_files axil_reg32.v] == "" } {
  import_files -quiet -fileset sources_1 /media/tony/TDG_512/projects/axil_stim0/hdl/axil_reg32.v
}
...
# axil_reg32, axil_reg32, axil_reg32, axil_reg32, axil_reg32, axil_reg32
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.892197",
   "Default View_TopLeft":"-603,3",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port S_AXI -pg 1 -lvl 0 -x -10 -y 220 -defaultsOSRD
preplace port S_AXI_0 -pg 1 -lvl 0 -x -10 -y 510 -defaultsOSRD
preplace port port-id_aclk -pg 1 -lvl 0 -x -10 -y 610 -defaultsOSRD
preplace port port-id_arstn -pg 1 -lvl 0 -x -10 -y 700 -defaultsOSRD
preplace inst axi_traffic_gen_0 -pg 1 -lvl 2 -x 480 -y 300 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 2 -x 480 -y 530 -defaultsOSRD
preplace inst axil_reg32_0 -pg 1 -lvl 3 -x 790 -y 90 -defaultsOSRD
preplace inst axil_reg32_1 -pg 1 -lvl 3 -x 790 -y 250 -defaultsOSRD
preplace inst axil_reg32_2 -pg 1 -lvl 3 -x 790 -y 410 -defaultsOSRD
preplace inst axil_reg32_3 -pg 1 -lvl 3 -x 790 -y 570 -defaultsOSRD
preplace inst axil_reg32_4 -pg 1 -lvl 3 -x 790 -y 890 -defaultsOSRD
preplace inst axil_reg32_5 -pg 1 -lvl 3 -x 790 -y 730 -defaultsOSRD
preplace inst smartconnect_1 -pg 1 -lvl 2 -x 480 -y 690 -defaultsOSRD
preplace inst axi_traffic_gen_1 -pg 1 -lvl 1 -x 170 -y 690 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 2 -x 480 -y 810 -defaultsOSRD
preplace netloc s_axi_aclk_0_1 1 0 3 10 610 320 380 650
preplace netloc s_axi_aresetn_0_1 1 0 3 20 600 330 390 660
preplace netloc xlconstant_0_dout 1 2 1 640 80n
preplace netloc S_AXI_0_1 1 0 3 NJ 220 NJ 220 NJ
preplace netloc S_AXI_0_2 1 0 2 NJ 510 NJ
preplace netloc axi_traffic_gen_0_M_AXI_LITE_CH1 1 2 1 630 60n
preplace netloc axi_traffic_gen_1_M_AXI_LITE_CH1 1 1 1 N 670
preplace netloc smartconnect_0_M00_AXI 1 2 1 670 380n
preplace netloc smartconnect_0_M01_AXI 1 2 1 N 540
preplace netloc smartconnect_1_M00_AXI 1 2 1 630 680n
preplace netloc smartconnect_1_M01_AXI 1 2 1 N 700
levelinfo -pg 1 -10 170 480 790 910
pagesize -pg 1 -db -bbox -sgen -120 0 910 980
"
}
...
cr_bd_sim_top ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files sim_top.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files sim_top.bd ] 
set_property IS_ENABLED "1" [get_files sim_top.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files sim_top.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files sim_top.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files sim_top.bd ] 
set_property PFM_NAME "" [get_files sim_top.bd ] 
...
set_property USED_IN "synthesis implementation simulation" [get_files sim_top.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files sim_top.bd ] 
set_property USED_IN_SIMULATION "1" [get_files sim_top.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files sim_top.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse sim_top.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/myproj/project_1.gen/sources_1/bd/sim_top/hdl/sim_top_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse sim_top.bd] -top]
